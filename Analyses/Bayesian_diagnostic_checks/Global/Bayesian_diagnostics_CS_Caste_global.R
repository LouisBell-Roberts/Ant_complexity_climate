######################## AntEnv: BPMM analysis diagnostic checks over 400 models - Global dataset ######################
...
setwd("/Volumes/ADATA SE800/DOL_worker_castes/AntEnv/Regressions/MCMCglmm/CS_response/Outputs/Global/2nd_run_11M_1M_10k/")
...
#Summary of results
quantile(unlist(gelman_results_CS_Sol)) #Only a single value >1.1
...
quantile(second_row_vec_fix_CS) # -0.0992238692 to 0.0918500873
...
quantile(second_row_vec_rand_CS) # -0.093956940 to 0.114010764; only a single value >0.1
...
quantile(ESS_vec_CS_fix) #lowest ESS = 563.1043; generally values are around 1000
...
quantile(ESS_vec_CS_rand) #lowest ESS = 706.3714; generally values are around 1000
