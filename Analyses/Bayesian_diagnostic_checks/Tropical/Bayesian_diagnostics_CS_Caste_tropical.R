######################## AntEnv: BPMM analysis diagnostic checks over 400 models - Tropical dataset ######################
...
setwd("/Volumes/ADATA SE800/DOL_worker_castes/AntEnv/Regressions/MCMCglmm/CS_response/Outputs/Tropical/2nd_run_11M_1M_10k/")
...
quantile(second_row_vec_fix_CS) # -0.1099160925 to 0.1071169576
# View(as.data.frame(second_row_vec_fix_CS)) #Only 5 values >0.1
...
quantile(second_row_vec_rand_CS) # -0.097134994 to 0.094934490; all <0.1
...
quantile(ESS_vec_CS_fix) #lowest ESS = 431.9417; generally values are around 1000
...
quantile(ESS_vec_CS_rand) #lowest ESS = 688.866; generally values are around 1000
