...
subtitle: "Path analysis: Tropical vs Temperate vs Both. No transformations"
...
# test <- phylolm(Colony_size ~ PREavg, data = ant_data_tropical_PREavg_selected_named, phy = tropical_anttree_NCuniform_stem, model = "lambda")
# summary(test)
...
```{r Tropical - PRE path coefficients CI, fig.width=14, fig.height=2}
#Estimate confidence intervals for path coefficients
##NCuniform_stem
# tropical_PREavg_CI_four_NCuniform_stem <- choice(tropical_PREavg_result_NCuniform_stem, "four", boot = 500)
# 
# ##NCuniform_crown
# tropical_PREavg_CI_four_NCuniform_crown <- choice(tropical_PREavg_result_NCuniform_crown, "four", boot = 500)
# 
# ##FBD_stem
# tropical_PREavg_CI_four_FBD_stem <- choice(tropical_PREavg_result_FBD_stem, "four", boot = 500)
# 
# ##FBD_crown
# tropical_PREavg_CI_four_FBD_crown <- choice(tropical_PREavg_result_FBD_crown, "four", boot = 500)

#Print out the tables and plots
##NCuniform_stem
###Individual models
# tropical_PREavg_CI_four_NCuniform_stem

###Averaged model
coef_plot(tropical_PREavg_average_model_full_NCuniform_stem, error_bar = "ci", reverse_order = TRUE) +
  ggplot2::coord_flip() +
  ggplot2::theme_bw(base_size = 17)

##NCuniform_crown
###Individual models
# tropical_PREavg_CI_four_NCuniform_crown

###Averaged model
coef_plot(tropical_PREavg_average_model_full_NCuniform_crown, error_bar = "ci", reverse_order = TRUE) +
  ggplot2::coord_flip() +
  ggplot2::theme_bw(base_size = 17)
...
###Averaged model
coef_plot(tropical_PREavg_average_model_full_FBD_stem, error_bar = "ci", reverse_order = TRUE) +
  ggplot2::coord_flip() +
  ggplot2::theme_bw(base_size = 17)

##FBD_crown
###Individual models
# tropical_PREavg_CI_four_FBD_crown

###Averaged model
coef_plot(tropical_PREavg_average_model_full_FBD_crown, error_bar = "ci", reverse_order = TRUE) +
  ggplot2::coord_flip() +
  ggplot2::theme_bw(base_size = 17)
```
...
temperate_PREavg_result_NCuniform_stem <- phylo_path(temperate_PREavg_models, data = ant_data_temperate_PREavg_selected_named, tree = temperate_anttree_NCuniform_stem, model = "lambda", method = "logistic_MPLE", btol = 30)
temperate_PREavg_result_NCuniform_crown  <- phylo_path(temperate_PREavg_models, data = ant_data_temperate_PREavg_selected_named, tree = temperate_anttree_NCuniform_crown, model = "lambda", method = "logistic_MPLE", btol = 30)
temperate_PREavg_result_FBD_stem <- phylo_path(temperate_PREavg_models, data = ant_data_temperate_PREavg_selected_named, tree = temperate_anttree_FBD_stem, model = "lambda", method = "logistic_MPLE", btol = 30)
temperate_PREavg_result_FBD_crown <- phylo_path(temperate_PREavg_models, data = ant_data_temperate_PREavg_selected_named, tree = temperate_anttree_FBD_crown, model = "lambda", method = "logistic_MPLE", btol = 30)
...
#Run the models on each of the 4 different MCC trees
both_PREavg_result_NCuniform_stem <- phylo_path(both_PREavg_models, data = ant_data_both_PREavg_selected_named, tree = both_anttree_NCuniform_stem, model = "lambda", method = "logistic_MPLE", btol = 30)
both_PREavg_result_NCuniform_crown  <- phylo_path(both_PREavg_models, data = ant_data_both_PREavg_selected_named, tree = both_anttree_NCuniform_crown, model = "lambda", method = "logistic_MPLE", btol = 30)
both_PREavg_result_FBD_stem <- phylo_path(both_PREavg_models, data = ant_data_both_PREavg_selected_named, tree = both_anttree_FBD_stem, model = "lambda", method = "logistic_MPLE", btol = 30)
both_PREavg_result_FBD_crown <- phylo_path(both_PREavg_models, data = ant_data_both_PREavg_selected_named, tree = both_anttree_FBD_crown, model = "lambda", method = "logistic_MPLE", btol = 30)
...
### Alternative causal models
```{r Tropical - Define the potential causal models TMPavg, fig.width=10, fig.height=6}
tropical_TMPavg_models <- define_model_set(
...
plot_model_set(tropical_TMPavg_models, box_x = 22, box_y = 8, text_size = 3.5)

```
### Path analysis
```{r Tropical - Analyse models TMPavg, fig.width=14, fig.height=5}
#Run the models on each of the 4 different MCC trees
tropical_TMPavg_result_NCuniform_stem <- phylo_path(tropical_TMPavg_models, data = ant_data_tropical_TMPavg_selected_named, tree = tropical_anttree_NCuniform_stem, model = "lambda", method = "logistic_MPLE")
tropical_TMPavg_result_NCuniform_crown  <- phylo_path(tropical_TMPavg_models, data = ant_data_tropical_TMPavg_selected_named, tree = tropical_anttree_NCuniform_crown, model = "lambda", method = "logistic_MPLE")
tropical_TMPavg_result_FBD_stem <- phylo_path(tropical_TMPavg_models, data = ant_data_tropical_TMPavg_selected_named, tree = tropical_anttree_FBD_stem, model = "lambda", method = "logistic_MPLE")
tropical_TMPavg_result_FBD_crown <- phylo_path(tropical_TMPavg_models, data = ant_data_tropical_TMPavg_selected_named, tree = tropical_anttree_FBD_crown, model = "lambda", method = "logistic_MPLE")


#Summarise the models
tropical_TMPavg_result_NCuniform_stem_summary <- tropical_TMPavg_result_NCuniform_stem %>% summary() %>% as.data.frame() %>% select(2:9) %>% round(digits = 2) %>% mutate(model = row.names(.)) %>% select(model, everything()) %>% rename("CICc difference" = delta_CICc) %>% filter(`CICc difference` <= 2)
 #k=number of conditional independencies tested; q=number of parameters estimated; l=likelihood; w=CICc weight
rownames(tropical_TMPavg_result_NCuniform_stem_summary) <- NULL

tropical_TMPavg_result_NCuniform_crown_summary <- tropical_TMPavg_result_NCuniform_crown %>% summary() %>% as.data.frame() %>% select(2:9) %>% round(digits = 2) %>% mutate(model = row.names(.)) %>% select(model, everything()) %>% rename("CICc difference" = delta_CICc) %>% filter(`CICc difference` <= 2)
 #k=number of conditional independencies tested; q=number of parameters estimated; l=likelihood; w=CICc weight
rownames(tropical_TMPavg_result_NCuniform_crown_summary) <- NULL

tropical_TMPavg_result_FBD_stem_summary <- tropical_TMPavg_result_FBD_stem %>% summary() %>% as.data.frame() %>% select(2:9) %>% round(digits = 2) %>% mutate(model = row.names(.)) %>% select(model, everything()) %>% rename("CICc difference" = delta_CICc) %>% filter(`CICc difference` <= 2)
 #k=number of conditional independencies tested; q=number of parameters estimated; l=likelihood; w=CICc weight
rownames(tropical_TMPavg_result_FBD_stem_summary) <- NULL

tropical_TMPavg_result_FBD_crown_summary <- tropical_TMPavg_result_FBD_crown %>% summary() %>% as.data.frame() %>% select(2:9) %>% round(digits = 2) %>% mutate(model = row.names(.)) %>% select(model, everything()) %>% rename("CICc difference" = delta_CICc) %>% filter(`CICc difference` <= 2)
 #k=number of conditional independencies tested; q=number of parameters estimated; l=likelihood; w=CICc weight
rownames(tropical_TMPavg_result_FBD_crown_summary) <- NULL

#Produce tables for Rmarkdown
kable(tropical_TMPavg_result_NCuniform_stem_summary, caption = "NCuniform stem path analysis model selection summary table") %>%
  kableExtra::kable_styling(latex_options = "hold_position") #The kableExtra chunk of code holds the table in position so that it does not start floating around the document
kable(tropical_TMPavg_result_NCuniform_crown_summary, caption = "NCuniform crown path analysis model selection summary table") %>%
  kableExtra::kable_styling(latex_options = "hold_position")
kable(tropical_TMPavg_result_FBD_stem_summary, caption = "FBD stem path analysis model selection summary table") %>%
  kableExtra::kable_styling(latex_options = "hold_position")
kable(tropical_TMPavg_result_FBD_crown_summary, caption = "FBD crown path analysis model selection summary table") %>%
  kableExtra::kable_styling(latex_options = "hold_position")
...
#Perform model averaging - 'full' allows shrinkage
tropical_TMPavg_average_model_full_NCuniform_stem <- average(tropical_TMPavg_result_NCuniform_stem, avg_method = "full")
tropical_TMPavg_average_model_full_NCuniform_crown <- average(tropical_TMPavg_result_NCuniform_crown, avg_method = "full")
tropical_TMPavg_average_model_full_FBD_stem <- average(tropical_TMPavg_result_FBD_stem, avg_method = "full")
tropical_TMPavg_average_model_full_FBD_crown <- average(tropical_TMPavg_result_FBD_crown, avg_method = "full")

# TMPsd_average_model <- average(TMPsd_result, avg_method = 'conditional') #no 'shrinkage'
plot(tropical_TMPavg_average_model_full_NCuniform_stem, algorithm = 'mds', curvature = 0.1, box_x = 10, box_y = 10, text_size = 5)
plot(tropical_TMPavg_average_model_full_NCuniform_crown, algorithm = 'mds', curvature = 0.1, box_x = 10, box_y = 10, text_size = 5)
plot(tropical_TMPavg_average_model_full_FBD_stem, algorithm = 'mds', curvature = 0.1, box_x = 10, box_y = 10, text_size = 5)
plot(tropical_TMPavg_average_model_full_FBD_crown, algorithm = 'mds', curvature = 0.1, box_x = 10, box_y = 10, text_size = 5)
```

#### Estimate confidence intervals for path coefficients
```{r Tropical - TMP path coefficients CI, fig.width=14, fig.height=2}
#Estimate confidence intervals for path coefficients
##NCuniform_stem
# tropical_TMPavg_CI_one_NCuniform_stem <- choice(tropical_TMPavg_result_NCuniform_stem, "one", boot = 500)
# 
# ##NCuniform_crown
# tropical_TMPavg_CI_one_NCuniform_crown <- choice(tropical_TMPavg_result_NCuniform_crown, "one", boot = 500)
# 
# ##FBD_stem
# tropical_TMPavg_CI_one_FBD_stem <- choice(tropical_TMPavg_result_FBD_stem, "one", boot = 500)
# 
# ##FBD_crown
# tropical_TMPavg_CI_one_FBD_crown <- choice(tropical_TMPavg_result_FBD_crown, "one", boot = 500)
# tropical_TMPavg_CI_three_FBD_crown <- choice(tropical_TMPavg_result_FBD_crown, "three", boot = 500)

#Print out the tables and plots
##NCuniform_stem
###Individual models
# tropical_TMPavg_CI_one_NCuniform_stem

###Averaged model
coef_plot(tropical_TMPavg_average_model_full_NCuniform_stem, error_bar = "ci", reverse_order = TRUE) +
  ggplot2::coord_flip() +
  ggplot2::theme_bw(base_size = 17)

##NCuniform_crown
###Individual models
# tropical_TMPavg_CI_one_NCuniform_crown
###Averaged model
coef_plot(tropical_TMPavg_average_model_full_NCuniform_crown, error_bar = "ci", reverse_order = TRUE) +
  ggplot2::coord_flip() +
  ggplot2::theme_bw(base_size = 17)

##FBD_stem
###Individual models
# tropical_TMPavg_CI_one_FBD_stem
###Averaged model
coef_plot(tropical_TMPavg_average_model_full_FBD_stem, error_bar = "ci", reverse_order = TRUE) +
  ggplot2::coord_flip() +
  ggplot2::theme_bw(base_size = 17)

##FBD_crown
###Individual models
# tropical_TMPavg_CI_one_FBD_crown
# tropical_TMPavg_CI_three_FBD_crown

###Averaged model
coef_plot(tropical_TMPavg_average_model_full_FBD_crown, error_bar = "ci", reverse_order = TRUE) +
  ggplot2::coord_flip() +
  ggplot2::theme_bw(base_size = 17)
```
...
#Run the models on each of the 4 different MCC trees
temperate_TMPavg_result_NCuniform_stem <- phylo_path(temperate_TMPavg_models, data = ant_data_temperate_TMPavg_selected_named, tree = temperate_anttree_NCuniform_stem, model = "lambda", method = "logistic_MPLE", btol = 20)
temperate_TMPavg_result_NCuniform_crown  <- phylo_path(temperate_TMPavg_models, data = ant_data_temperate_TMPavg_selected_named, tree = temperate_anttree_NCuniform_crown, model = "lambda", method = "logistic_MPLE", btol = 10)
temperate_TMPavg_result_FBD_stem <- phylo_path(temperate_TMPavg_models, data = ant_data_temperate_TMPavg_selected_named, tree = temperate_anttree_FBD_stem, model = "lambda", method = "logistic_MPLE", btol = 20)
temperate_TMPavg_result_FBD_crown <- phylo_path(temperate_TMPavg_models, data = ant_data_temperate_TMPavg_selected_named, tree = temperate_anttree_FBD_crown, model = "lambda", method = "logistic_MPLE", btol = 20)
...
#Run the models on each of the 4 different MCC trees
both_TMPavg_result_NCuniform_stem <- phylo_path(both_TMPavg_models, data = ant_data_both_TMPavg_selected_named, tree = both_anttree_NCuniform_stem, model = "lambda", method = "logistic_MPLE", btol = 30)
both_TMPavg_result_NCuniform_crown  <- phylo_path(both_TMPavg_models, data = ant_data_both_TMPavg_selected_named, tree = both_anttree_NCuniform_crown, model = "lambda", method = "logistic_MPLE", btol = 30)
both_TMPavg_result_FBD_stem <- phylo_path(both_TMPavg_models, data = ant_data_both_TMPavg_selected_named, tree = both_anttree_FBD_stem, model = "lambda", method = "logistic_MPLE", btol = 30)
both_TMPavg_result_FBD_crown <- phylo_path(both_TMPavg_models, data = ant_data_both_TMPavg_selected_named, tree = both_anttree_FBD_crown, model = "lambda", method = "logistic_MPLE", btol = 30)
