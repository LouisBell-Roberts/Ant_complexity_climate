...
subtitle: "Path analysis using PCA - Regional using conditional averaging with PC2"
...
## Tropical
### NCuniform stem tree
Factor loading PC2: TMP: positive; PRE: negative
...
(result_tropical_NCuniform_stem_plot <- plot(result_tropical_NCuniform_stem_average_conditional, algorithm = 'nicely', curvature = 0.1, box_x = 20, box_y = 12, text_size = 5, labels = c(Colony_size = "CS",  Poly_id = "WP", Climate2 = "PC2"))
)
...
Factor loading PC1: TMP: negative; PRE: positive
...
(result_tropical_NCuniform_crown_plot <- plot(result_tropical_NCuniform_crown_average_conditional, algorithm = 'nicely', curvature = 0.1, box_x = 20, box_y = 12, text_size = 5, labels = c(Colony_size = "CS",  Poly_id = "WP", Climate2 = "PC2"))
)
...
### FBD stem tree
Factor loading PC1: TMP: positive; PRE: negative
...
(result_tropical_FBD_stem_plot <- plot(result_tropical_FBD_stem_average_conditional, algorithm = 'nicely', curvature = 0.1, box_x = 20, box_y = 12, text_size = 5, labels = c(Colony_size = "CS",  Poly_id = "WP", Climate2 = "PC2"))
)
...
(result_tropical_FBD_crown_plot <- plot(result_tropical_FBD_crown_average_conditional, algorithm = 'nicely', curvature = 0.1, box_x = 20, box_y = 12, text_size = 5, labels = c(Colony_size = "CS",  Poly_id = "WP", Climate2 = "PC2"))
)
...
(result_temperate_NCuniform_stem_plot <- plot(result_temperate_NCuniform_stem_average_conditional, algorithm = 'sugiyama', curvature = 0.04, box_x = 20, box_y = 12, text_size = 5, labels = c(Colony_size = "CS",  Poly_id = "WP", Climate2 = "PC2"))
)
...
(result_temperate_NCuniform_crown_plot <- plot(result_temperate_NCuniform_crown_average_conditional, algorithm = 'sugiyama', curvature = 0.04, box_x = 20, box_y = 12, text_size = 5, labels = c(Colony_size = "CS",  Poly_id = "WP", Climate2 = "PC2"))
)
...
(result_temperate_FBD_stem_plot <- plot(result_temperate_FBD_stem_average_conditional, algorithm = 'sugiyama', curvature = 0.04, box_x = 20, box_y = 12, text_size = 5, labels = c(Colony_size = "CS",  Poly_id = "WP", Climate2 = "PC2"))
)
...
(result_temperate_FBD_crown_plot <- plot(result_temperate_FBD_crown_average_conditional, algorithm = 'sugiyama', curvature = 0.04, box_x = 20, box_y = 12, text_size = 5, labels = c(Colony_size = "CS",  Poly_id = "WP", Climate2 = "PC2"))
)
...
(result_both_NCuniform_stem_plot <- plot(result_both_NCuniform_stem_average_conditional, algorithm = 'sugiyama', curvature = 0.04, box_x = 20, box_y = 12, text_size = 5, labels = c(Colony_size = "CS",  Poly_id = "WP", Climate2 = "PC2"))
)
...
(result_both_NCuniform_crown_plot <- plot(result_both_NCuniform_crown_average_conditional, algorithm = 'sugiyama', curvature = 0.04, box_x = 20, box_y = 12, text_size = 5, labels = c(Colony_size = "CS",  Poly_id = "WP", Climate2 = "PC2"))
)
...
(result_both_FBD_stem_plot <- plot(result_both_FBD_stem_average_conditional, algorithm = 'sugiyama', curvature = 0.04, box_x = 20, box_y = 12, text_size = 5, labels = c(Colony_size = "CS",  Poly_id = "WP", Climate2 = "PC2"))
)
...
(result_both_FBD_crown_plot <- plot(result_both_FBD_crown_average_conditional, algorithm = 'sugiyama', curvature = 0.04, box_x = 20, box_y = 12, text_size = 5, labels = c(Colony_size = "CS",  Poly_id = "WP", Climate2 = "PC2"))
)
...
combined_avg_mod_sel_tables <- rbind(read.csv("/Users/louis.bell-roberts/Documents/Github/Division-of-labour/Phylogenetic_analysis/Ant_environmental_data/Analyses/Path_analysis/All_sp_474/Without_transformation/Phylo_PCA/Results/Path_analysis_Global_PC2_summary_conditional_avg.csv"), read.csv("/Users/louis.bell-roberts/Documents/Github/Division-of-labour/Phylogenetic_analysis/Ant_environmental_data/Analyses/Path_analysis/Tropical_vs_Temperate_vs_Both/Without_transformation/Phylo_PCA/Results/Path_analysis_Tropical_PC2_summary_conditional_avg.csv"), read.csv("/Users/louis.bell-roberts/Documents/Github/Division-of-labour/Phylogenetic_analysis/Ant_environmental_data/Analyses/Path_analysis/Tropical_vs_Temperate_vs_Both/Without_transformation/Phylo_PCA/Results/Path_analysis_Temperate_PC2_summary_conditional_avg.csv"), read.csv("/Users/louis.bell-roberts/Documents/Github/Division-of-labour/Phylogenetic_analysis/Ant_environmental_data/Analyses/Path_analysis/Tropical_vs_Temperate_vs_Both/Without_transformation/Phylo_PCA/Results/Path_analysis_Both_PC2_summary_conditional_avg.csv"))
...
combined_avg_mod_path_coef_tables <- rbind(read.csv("/Users/louis.bell-roberts/Documents/Github/Division-of-labour/Phylogenetic_analysis/Ant_environmental_data/Analyses/Path_analysis/All_sp_474/Without_transformation/Phylo_PCA/Results/Path_analysis_Global_PC2_coef_stats_conditional_averaged_models.csv"), read.csv("/Users/louis.bell-roberts/Documents/Github/Division-of-labour/Phylogenetic_analysis/Ant_environmental_data/Analyses/Path_analysis/Tropical_vs_Temperate_vs_Both/Without_transformation/Phylo_PCA/Results/Path_analysis_Tropical_PC2_coef_stats_conditional_averaged_model.csv"), read.csv("/Users/louis.bell-roberts/Documents/Github/Division-of-labour/Phylogenetic_analysis/Ant_environmental_data/Analyses/Path_analysis/Tropical_vs_Temperate_vs_Both/Without_transformation/Phylo_PCA/Results/Path_analysis_Temperate_PC2_coef_stats_conditional_averaged_model.csv"), read.csv("/Users/louis.bell-roberts/Documents/Github/Division-of-labour/Phylogenetic_analysis/Ant_environmental_data/Analyses/Path_analysis/Tropical_vs_Temperate_vs_Both/Without_transformation/Phylo_PCA/Results/Path_analysis_Both_PC2_coef_stats_conditional_averaged_model.csv"))
...
write.csv(combined_avg_mod_path_coef_tables_region, file = "/Users/louis.bell-roberts/Documents/Github/Division-of-labour/Phylogenetic_analysis/Ant_environmental_data/Analyses/Path_analysis/Tropical_vs_Temperate_vs_Both/Without_transformation/Phylo_PCA/Results/Path_analysis_All_Regions_PC2_coef_stats_conditional_averaged_model.csv", row.names = F)
```