########## R2 calculations for caste using MCMCglmm - Shinichi method ###########
####Across 400 trees
###Binary data
#29/10/2023
#Louis Bell-Roberts
...
setwd('/Volumes/ADATA SE800/DOL_worker_castes/AntEnv/Regressions/MCMCglmm/Caste_response/Outputs/Global/No_fixed_effect_X2_rand/1st_run_11M_1M_10k/')

#Read in all of the individual models
mcmc_list_caste_1st_global <- model_reader_function()
#
...
R2_marginal_single_global <- MCMCglmm_R2_marginal_with_CI_binary(mcmc_list_caste_1st_global[[1]]) #Apply to a single MCMCglmm model
R2_marginal_results_list_global <- lapply(mcmc_list_caste_1st_global, MCMCglmm_R2_marginal_with_CI_binary) #Apply across a list of MCMCglmm models
...
quantile(R2_marginal_distribution_global$post_mode_R2) #0.04209058
quantile(R2_marginal_distribution_global$lower_CI) #0.008694718
quantile(R2_marginal_distribution_global$upper_CI) #0.10121464
...
R2_conditional_single_globa <- MCMCglmm_R2_conditional_with_CI_binary(mcmc_list_caste_1st_global[[1]]) #Apply to a single MCMCglmm model
R2_conditional_results_list_global <- lapply(mcmc_list_caste_1st_global, MCMCglmm_R2_conditional_with_CI_binary) #Apply across a list of MCMCglmm models

#Create R2 marginal distribution data frame
R2_conditional_distribution_global <- convert_results_list_to_dataframe(R2_conditional_results_list_global)
quantile(R2_conditional_distribution_global$post_mode_R2) #0.7875041
...
#Set working directory
setwd('/Volumes/ADATA SE800/DOL_worker_castes/AntEnv/Regressions/MCMCglmm/Caste_response/Outputs/Tropical/No_fixed_effect_X2_rand/1st_run_11M_1M_10k/')

#Read in all of the individual models
mcmc_list_caste_1st_tropical <- model_reader_function()
#
...
#Calculate R2_marginal values across the 400 trees along with their associated CI
R2_marginal_single_tropical <- MCMCglmm_R2_marginal_with_CI_binary(mcmc_list_caste_1st_tropical[[1]]) #Apply to a single MCMCglmm model
R2_marginal_results_list_tropical <- lapply(mcmc_list_caste_1st_tropical, MCMCglmm_R2_marginal_with_CI_binary) #Apply across a list of MCMCglmm models

#Create R2 marginal distribution data frame
R2_marginal_distribution_tropical <- convert_results_list_to_dataframe(R2_marginal_results_list_tropical)
quantile(R2_marginal_distribution_tropical$post_mode_R2) #0.07894859
...
#Calculate R2_conditional values across the 400 trees along with their associated CI
R2_conditional_single_tropical <- MCMCglmm_R2_conditional_with_CI_binary(mcmc_list_caste_1st_tropical[[1]]) #Apply to a single MCMCglmm model
R2_conditional_results_list_tropical <- lapply(mcmc_list_caste_1st_tropical, MCMCglmm_R2_conditional_with_CI_binary) #Apply across a list of MCMCglmm models

#Create R2 marginal distribution data frame
R2_conditional_distribution_tropical <- convert_results_list_to_dataframe(R2_conditional_results_list_tropical)
quantile(R2_conditional_distribution_tropical$post_mode_R2) #0.6959782
...
#Set working directory
setwd('/Volumes/ADATA SE800/DOL_worker_castes/AntEnv/Regressions/MCMCglmm/Caste_response/Outputs/Temperate/No_fixed_effect_X2_rand/1st_run_11M_1M_10k/')

#Read in all of the individual models
mcmc_list_caste_1st_temperate <- model_reader_function()
#
...
#Calculate R2_marginal values across the 400 trees along with their associated CI
R2_marginal_single_temperate <- MCMCglmm_R2_marginal_with_CI_binary(mcmc_list_caste_1st_temperate[[1]]) #Apply to a single MCMCglmm model
R2_marginal_results_list_temperate <- lapply(mcmc_list_caste_1st_temperate, MCMCglmm_R2_marginal_with_CI_binary) #Apply across a list of MCMCglmm models

#Create R2 marginal distribution data frame
R2_marginal_distribution_temperate <- convert_results_list_to_dataframe(R2_marginal_results_list_temperate)
quantile(R2_marginal_distribution_temperate$post_mode_R2) #0.04195890
...
#Calculate R2_conditional values across the 400 trees along with their associated CI
R2_conditional_single_temperate <- MCMCglmm_R2_conditional_with_CI_binary(mcmc_list_caste_1st_temperate[[1]]) #Apply to a single MCMCglmm model
R2_conditional_results_list_temperate <- lapply(mcmc_list_caste_1st_temperate, MCMCglmm_R2_conditional_with_CI_binary) #Apply across a list of MCMCglmm models

#Create R2 marginal distribution data frame
R2_conditional_distribution_temperate <- convert_results_list_to_dataframe(R2_conditional_results_list_temperate)
quantile(R2_conditional_distribution_temperate$post_mode_R2) #0.6824046
...
#Set working directory
setwd('/Volumes/ADATA SE800/DOL_worker_castes/AntEnv/Regressions/MCMCglmm/Caste_response/Outputs/Both/No_fixed_effect_X2_rand/1st_run_11M_1M_10k/')

#Read in all of the individual models
mcmc_list_caste_1st_both <- model_reader_function()
#
...
#Calculate R2_marginal values across the 400 trees along with their associated CI
R2_marginal_single_both <- MCMCglmm_R2_marginal_with_CI_binary(mcmc_list_caste_1st_both[[1]]) #Apply to a single MCMCglmm model
R2_marginal_results_list_both <- lapply(mcmc_list_caste_1st_both, MCMCglmm_R2_marginal_with_CI_binary) #Apply across a list of MCMCglmm models

#Create R2 marginal distribution data frame
R2_marginal_distribution_both <- convert_results_list_to_dataframe(R2_marginal_results_list_both)
quantile(R2_marginal_distribution_both$post_mode_R2) #0.11242057
...
#Calculate R2_conditional values across the 400 trees along with their associated CI
R2_conditional_single_both <- MCMCglmm_R2_conditional_with_CI_binary(mcmc_list_caste_1st_both[[1]]) #Apply to a single MCMCglmm model
R2_conditional_results_list_both <- lapply(mcmc_list_caste_1st_both, MCMCglmm_R2_conditional_with_CI_binary) #Apply across a list of MCMCglmm models

#Create R2 marginal distribution data frame
R2_conditional_distribution_both <- convert_results_list_to_dataframe(R2_conditional_results_list_both)
quantile(R2_conditional_distribution_both$post_mode_R2) #0.7202904
