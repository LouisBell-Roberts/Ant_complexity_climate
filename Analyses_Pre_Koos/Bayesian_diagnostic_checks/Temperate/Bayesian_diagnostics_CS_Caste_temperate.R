######################## AntEnv: BPMM analysis diagnostic checks over 400 models - Temperate dataset ######################
...
setwd("/Volumes/ADATA SE800/DOL_worker_castes/AntEnv/Regressions/MCMCglmm/CS_response/Outputs/Temperate/2nd_run_11M_1M_10k/")
...
#Summary of results
quantile(unlist(gelman_results_CS_Sol)) #All <1.1
...
#Summary of results
quantile(unlist(CS_gelman_results_VCV)) #All <1.1
...
quantile(second_row_vec_fix_CS) # -0.097439253 to 0.111009871
# View(as.data.frame(second_row_vec_fix_CS)) #Only 3 values >0.1
...
quantile(second_row_vec_rand_CS) # -0.1177968206 to 0.0874744162; only a single value >0.1
...
quantile(ESS_vec_CS_fix) #lowest ESS = 536.3942; generally values are around 1000
...
quantile(ESS_vec_CS_rand) #lowest ESS = 608.944; generally values are around 1000
