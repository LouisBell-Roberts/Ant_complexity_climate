...
subtitle: "Path analysis using PCA - Global using conditional averaging with PC2"
...
(result_NCuniform_stem_average_conditional_plot <- plot(result_NCuniform_stem_average_conditional, algorithm = 'sugiyama', curvature = 0.04, box_x = 20, box_y = 12, text_size = 5, labels = c(Colony_size = "CS",  Poly_id = "WP", Climate2 = "PC2"))
)
...
#Run the models on each of the 4 different MCC trees
anttree_NCuniform_crown_selected_named$Climate2 <- -anttree_NCuniform_crown_selected_named$Climate2 #Reverse sign for each of the relationships with Climate
...
(result_NCuniform_crown_average_conditional_plot <- plot(result_NCuniform_crown_average_conditional, algorithm = 'sugiyama', curvature = 0.04, box_x = 20, box_y = 12, text_size = 5, labels = c(Colony_size = "CS",  Poly_id = "WP", Climate2 = "PC2"))
)
...
(result_FBD_stem_average_conditional_plot <- plot(result_FBD_stem_average_conditional, algorithm = 'sugiyama', curvature = 0.04, box_x = 20, box_y = 12, text_size = 5, labels = c(Colony_size = "CS",  Poly_id = "WP", Climate2 = "PC2"))
)
...
(result_FBD_crown_average_conditional_plot <- plot(result_FBD_crown_average_conditional, algorithm = 'sugiyama', curvature = 0.04, box_x = 20, box_y = 12, text_size = 5, labels = c(Colony_size = "CS",  Poly_id = "WP", Climate2 = "PC2"))
)
...
# Create a PDF file
pdf("/Users/louis.bell-roberts/Documents/DTP_1st_project_rotation/Wordfiles/Paper drafting/AntEnv/Supplementary_materials/Figures/Path_analysis_global_PCA_PC2_average_4panel_conditional_avg.pdf", width = 11, height = 13)
...
write.csv(combined_summaries, file = "/Users/louis.bell-roberts/Documents/Github/Division-of-labour/Phylogenetic_analysis/Ant_environmental_data/Analyses/Path_analysis/All_sp_474/Without_transformation/Phylo_PCA/Results/Path_analysis_Global_PC2_summary_conditional_avg.csv", row.names = FALSE)
...
write.csv(PA_coef_stats, file = "/Users/louis.bell-roberts/Documents/Github/Division-of-labour/Phylogenetic_analysis/Ant_environmental_data/Analyses/Path_analysis/All_sp_474/Without_transformation/Phylo_PCA/Results/Path_analysis_Global_PC2_coef_stats_conditional_avg.csv", row.names = F)
```
...
write.csv(combined_summaries_avg_mods, file = "/Users/louis.bell-roberts/Documents/Github/Division-of-labour/Phylogenetic_analysis/Ant_environmental_data/Analyses/Path_analysis/All_sp_474/Without_transformation/Phylo_PCA/Results/Path_analysis_Global_PC2_coef_stats_conditional_averaged_models.csv", row.names = FALSE)
